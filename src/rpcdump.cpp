...
Value dumpprivkey(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"communityaddress\"\n"
            "\nReveals the private key corresponding to 'communityaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"communityaddress\"   (string, required) The community address for the private key\n"
            "\nResult:\n"
...
Value dumpwallet(const Array& params, bool fHelp)
{
    ...
    // produce output
    file << strprintf("# Wallet dump created by COMMUNITY %s (%s)\n", CLIENT_BUILD, CLIENT_DATE);
...
Value bip38encrypt(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "bip38encrypt \"communityaddress\"\n"
            "\nEncrypts a private key corresponding to 'communityaddress'.\n"
            "\nArguments:\n"
            "1. \"communityaddress\"   (string, required) The community address for the private key (you must hold the key already)\n"
