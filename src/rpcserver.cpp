...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop COMMUNITY server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "COMMUNITY server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* COMMUNITY features */
        {"community", "masternode", &masternode, true, true, false},
        {"community", "masternodelist", &masternodelist, true, true, false},
        {"community", "mnbudget", &mnbudget, true, true, false},
        {"community", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"community", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"community", "mnsync", &mnsync, true, true, false},
        {"community", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"community", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use communityd, or the -server option to community-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
