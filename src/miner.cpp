...
bool ProcessBlockFound(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != chainActive.Tip()->GetBlockHash())
            return error("COMMUNITYMiner : generated block is stale");
    }
    ...
    if (!ProcessNewBlock(state, NULL, pblock))
        return error("COMMUNITYMiner : ProcessNewBlock, block not accepted");
...
{
    LogPrintf("COMMUNITYMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("community-miner");
    ...
    while (fGenerateBitcoins || fProofOfStake) {
        ...
        if (fProofOfStake) {
            ...
            if (!pblock->SignBlock(*pwallet)) {
                LogPrintf("COMMUNITYMiner(): Signing new block failed \n");
                continue;
            }
        ...
        LogPrintf("Running COMMUNITYMiner with %u transactions in block (%u bytes)\n", pblock->vtx.size(),
...
void static ThreadBitcoinMiner(void* parg)
{
    ...
    try {
        ...
        LogPrintf("ThreadCOMMUNITYMiner() exception");
    } catch (...) {
        LogPrintf("ThreadCOMMUNITYMiner() exception");
    }

    LogPrintf("ThreadCOMMUNITYMiner exiting\n");
}
