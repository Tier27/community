                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("COMMUNITY-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About COMMUNITY Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for COMMUNITY"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the COMMUNITY Core help message to get a list with possible COMMUNITY command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("COMMUNITY Core client") + " " + networkStyle->getTitleAddText();
