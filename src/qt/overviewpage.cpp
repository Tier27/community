...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate() : QAbstractItemDelegate(), unit(BitcoinUnits::COMMUNITY)
    {
    }
...
void OverviewPage::setWalletModel(WalletModel* model)
{
    ...
    // update the display unit, to not use the default ("COMMUNITY")
    updateDisplayUnit();
}
...
void OverviewPage::updateDarksendProgress()
{
    ...
    QString strAnonymizeCOMMUNITYAmount = BitcoinUnits::formatHtmlWithUnit(nDisplayUnit, nAnonymizeCOMMUNITYAmount * COIN, false, BitcoinUnits::separatorAlways);
    ...
    if (currentBalance == 0) {
        ...
        strAnonymizeCOMMUNITYAmount = strAnonymizeCOMMUNITYAmount.remove(strAnonymizeCOMMUNITYAmount.indexOf("."), BitcoinUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = strAnonymizeCOMMUNITYAmount + " / " + tr("%n Rounds", "", nDarksendRounds);
    ...
    if (nMaxToAnonymize > nAnonymizeCOMMUNITYAmount * COIN) nMaxToAnonymize = nAnonymizeCOMMUNITYAmount * COIN;

    if (nMaxToAnonymize == 0) return;

    if (nMaxToAnonymize >= nAnonymizeCOMMUNITYAmount * COIN) {
        ui->labelAmountRounds->setToolTip(tr("Found enough compatible inputs to anonymize %1")
                                              .arg(strAnonymizeCOMMUNITYAmount));
        strAnonymizeCOMMUNITYAmount = strAnonymizeCOMMUNITYAmount.remove(strAnonymizeCOMMUNITYAmount.indexOf("."), BitcoinUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = strAnonymizeCOMMUNITYAmount + " / " + tr("%n Rounds", "", nDarksendRounds);
    } else {
...
void OverviewPage::toggleDarksend()
{
    ...
    if (!fEnableDarksend) {
        ...
        if (nAnonymizeCOMMUNITYAmount == 0) {
