...
In order to support loading of multiple wallets in community-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is community.cpp.
...
Changes to community.cpp
----------------------
community.cpp is the entry point into community-qt, and as such, will require some minor modifications to provide hooks for
