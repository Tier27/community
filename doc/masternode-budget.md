...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<community_address\> \<monthly_payment_community\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ COMMUNITY, _12_ times over the course of a year totaling _24000_ COMMUNITY.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<community_address\> \<monthly_payment_community\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` COMMUNITY.
 ...
 * vote-many          - Vote on a COMMUNITY initiative
 * vote-alias         - Vote on a COMMUNITY initiative
 * vote               - Vote on a COMMUNITY initiative/budget
